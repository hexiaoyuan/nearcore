...
git fetch upstream
git switch -c 1.36.4-pt01 upstream/1.36.4
git push --set-upstream origin 1.36.4-pt01
.... coding ....
git commit
.... .... .... ....
git push
#
#
git clone -b 1.36.4-pt01 --single-branch https://github.com/hexiaoyuan/nearcore.git src; cd src;
...
https://github.com/near/nearcore/compare/1.36.4...hexiaoyuan:nearcore:1.36.4-pt01
```
